Shader "Archipin/FX/Fx_MaskUV_Loop_URP_AlphaUVNoise_Light"
{
    Properties
    {
        ...
        Pass
        {
           HLSLPROGRAM
            ...
            {          
              ...
              float4 c = tex2D(_MainTex,float2(i.uv.x - (_Time.x*15) * _MainTexXSpeed, i.uv.y - _Time.y * _MainTexYSpeed) + w) * _TintColor * _AddInt;
              ...
              float4 alpha = tex2D(_AlphaTex, float2(i.uv2.x - (_Time.x*15) * _AlphaXSpeed, i.uv2.y - _Time.y * _AlphaYSpeed) + w);
