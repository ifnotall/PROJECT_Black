Shader "Archipin/FX/Fx_Particle_Basic_URP_IntSin"
{
    Properties
    {
        ...
        _AddIntTime("AddIntTime", float) = 1
        ...
        Pass
        {
           ...
           #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            ...
            {          
              ...
              float s = sin(_Time.y * _AddIntTime);
              float4 c = tex2D(_MainTex, i.uv) * _TintColor * (_AddInt * s);
