Shader "Archipin/FX/Fx_MaskUV_Loop_URP_2Tex_SeAdd"
{
    Properties
    {
        ...
        Pass
        {
           ...
           #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            ...
            {          
              ...
              float4 s = tex2D(_SecondTex, float2(i.uv3.x - (_Time.x*15) * _SecondTexXSpeed, i.uv3.y - _Time.y * _SecondTexYSpeed)) * _SeInt;  
