Shader "Archipin/FX/Fx_MaskUV_Loop_URP_2Tex_AlphaUV"
{
    Properties
    {
        ...
        Pass
        {
           ...
           #include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            ...
            {          
              ...
              float4 w = tex2D(_NoiseTex, float2(i.uv1.x - (_Time.x*15) * _NoiseXSpeed, i.uv1.y - _Time.y * _NoiseYSpeed)) * _NoisePower;  
